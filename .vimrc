...
call vundle#begin()
    ...
    "------------------=== Pep8 ===---------------------------------
    Plugin 'vim-scripts/indentpython.vim'       " aids auto indent
...
set mouse=a                                 " mouse setting

set pastetoggle=<F2>                        "Better copy and past
...
"use shift + " to open and close nerdtree
...
autocmd BufWritePost *.py call Flake8()     " Auto check pep8 durring write
